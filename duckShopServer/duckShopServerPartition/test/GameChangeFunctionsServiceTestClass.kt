...
internal val addRandomDuckListMethod = TestMethod(
    "addRandomDuck",
    returnType = TestKotlinType("Duck"),
    arguments = listOf(
        TestVariable(
            "list",
            javaType = "List",
...
internal val addRandomDuckSetMethod = TestMethod(
    "addRandomDuck",
    returnType = TestKotlinType("Duck"),
    arguments = listOf(
        TestVariable(
...
internal val addRandomDuckMapMethod = TestMethod(
    "addRandomDuck",
    returnType = TestKotlinType(
        "Pair",
        params = listOf("org.jetbrains.kotlin.course.duck.shop.duck.Duck", "kotlim.String"),
    ),
    arguments = listOf(
        TestVariable(
            "map",
...
internal val gameChangeFunctionsServiceTestClass = TestClass(
    ...
    customMethods = listOf(
        ...
        addRandomDuckListMethod,
        addRandomDuckSetMethod,
        addRandomDuckMapMethod
    ),
)
