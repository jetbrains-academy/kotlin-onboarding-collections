...
The current tasks can be found in the [open issues](https://github.com/jetbrains-academy/kotlin-onboarding-part3/issues) in the project.
...
- You don't have code-style problems according the [GitHub Actions](https://github.com/jetbrains-academy/kotlin-onboarding-part3/tree/main/.github/workflows)
